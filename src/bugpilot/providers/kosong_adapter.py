...
from kosong.chat_provider import ChatProvider, StreamedMessagePart
...
class KosongAdapter(LLMProvider):
    ...
    def __init__(self, chat_provider: ChatProvider, supports_tools: bool = True, supports_reasoning: bool = False):
