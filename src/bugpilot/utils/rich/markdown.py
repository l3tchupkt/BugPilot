...
from bugpilot.utils.rich.syntax import BUGPILOT_ANSI_THEME_NAME, resolve_code_theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = BUGPILOT_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "bugpilot-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = BUGPILOT_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=BUGPILOT_ANSI_THEME_NAME,
        help='code theme (pygments name or "bugpilot-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
