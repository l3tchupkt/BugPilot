...
from bugpilot.tools.display import (
...
from bugpilot.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `bugpilot.soul.approval.Request`, but
