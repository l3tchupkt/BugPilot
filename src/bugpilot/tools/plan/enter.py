...
from bugpilot.soul import get_wire_or_none, wire_send
from bugpilot.soul.toolset import get_current_tool_call_or_none
from bugpilot.tools.utils import load_desc
from bugpilot.wire.types import QuestionItem, QuestionNotSupported, QuestionOption, QuestionRequest
...
class EnterPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        *,
        ...
        """Late-bind soul callbacks after Agent is constructed."""
