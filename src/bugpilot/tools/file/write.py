...
from bugpilot.tools.display import DisplayBlock
from bugpilot.tools.file import FileActions
from bugpilot.tools.file.plan_mode import inspect_plan_edit_target
from bugpilot.tools.utils import load_desc
from bugpilot.utils.diff import build_diff_blocks
from bugpilot.utils.logging import logger
from bugpilot.utils.path import is_within_workspace, kaos_path_from_user_input
...
class WriteFile(CallableTool2[Params]):
    ...
    def __init__(self, runtime: Runtime, approval: Approval):
        super().__init__()
        self._work_dir = runtime.builtin_args.BUGPILOT_WORK_DIR
