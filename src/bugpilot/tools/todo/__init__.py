...
from bugpilot.session_state import TodoItemState
from bugpilot.soul.agent import Runtime
from bugpilot.tools.display import TodoDisplayBlock, TodoDisplayItem
...
class SetTodoList(CallableTool2[Params]):
    ...
    def _write_subagent_state(path: Path, data: dict[str, Any]) -> None:
        from bugpilot.utils.io import atomic_json_write
