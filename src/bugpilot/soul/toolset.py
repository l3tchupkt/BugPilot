...
from bugpilot.exception import InvalidToolError, MCPRuntimeError
...
class Toolset:
    ...
    def load_tools(self, tool_paths: list[str], dependencies: dict[type[Any], Any]) -> None:
        """
        Load tools from paths like `bugpilot.tools.shell:Shell`.
    ...
    async def load_mcp_tools(
        ...
        from bugpilot.mcp_oauth import create_mcp_oauth, has_mcp_oauth_tokens
        ...
        def _mark_oauth_unauthorized(server_name: str) -> None:
            logger.warning(
                ...
                "Run 'bugpilot mcp auth {server_name}' first.",
...
class WireExternalTool(CallableTool):
    ...
    async def __call__(self, *args: Any, **kwargs: Any) -> ToolReturnValue:
        ...
        from bugpilot.soul import get_wire_or_none
