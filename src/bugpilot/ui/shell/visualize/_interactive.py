...
from bugpilot.ui.shell.console import console, render_to_ansi
from bugpilot.ui.shell.echo import render_user_echo_text
from bugpilot.ui.shell.keyboard import KeyEvent
from bugpilot.ui.shell.prompt import (
    CustomPromptSession,
    UserInput,
)
from bugpilot.ui.shell.visualize._btw_panel import _BtwModalDelegate
from bugpilot.ui.shell.visualize._input_router import InputAction, classify_input
from bugpilot.ui.shell.visualize._live_view import _LiveView
    ...
    def handle_local_input(self, user_input: UserInput) -> None:
        ...
        match action.kind:
            ...
            case InputAction.QUEUE:
                ...
                from bugpilot.utils.slashcmd import parse_slash_command_call
                ...
                if cmd := parse_slash_command_call(user_input.resolved_command.strip()):
                    ...
                    if shell_registry.find_command(cmd.name) is not None:
                        from bugpilot.ui.shell.prompt import toast
