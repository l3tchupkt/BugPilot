...
from bugpilot.soul import StatusSnapshot, format_context_status
from bugpilot.ui.shell import placeholders as prompt_placeholders
from bugpilot.ui.shell.console import console
from bugpilot.ui.shell.placeholders import (
    PromptPlaceholderManager,
    normalize_pasted_text,
    sanitize_surrogates,
)
from bugpilot.ui.theme import get_prompt_style, get_toolbar_colors
from bugpilot.utils.clipboard import (
...
from bugpilot.wire.types import ContentPart
...
class LocalFileMentionCompleter(Completer):
    ...
    :mod:`bugpilot.utils.file_filter` so that the web backend can reuse
    them.
    """
    ...
    def _get_top_level_paths(self) -> list[str]:
        from bugpilot.utils.file_filter import is_ignored
    ...
    def _get_deep_paths(self) -> list[str]:
        from bugpilot.utils.file_filter import (
            detect_git,
            git_index_mtime,
            list_files_git,
            list_files_walk,
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from bugpilot.utils.editor import edit_text_in_editor, get_editor_command
