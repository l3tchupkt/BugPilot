...
from bugpilot.background import TaskView, is_terminal_status
from bugpilot.soul.agent_loop import Agent
from bugpilot.ui.shell.console import console
from bugpilot.utils.datetime import format_duration, format_relative_time
...
def _task_browser_style() -> Style:
    from bugpilot.ui.theme import get_task_browser_style
