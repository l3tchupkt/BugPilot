...
from bugpilot.utils.envvar import get_env_int
from bugpilot.utils.logging import logger
from bugpilot.utils.media_tags import wrap_media_part
from bugpilot.utils.string import random_string
from bugpilot.wire.types import ContentPart, ImageURLPart, TextPart

_DEFAULT_PROMPT_CACHE_ROOT = get_share_dir() / "prompt-cache"
_LEGACY_PROMPT_CACHE_ROOT = Path("/tmp/bugpilot")
...
_TEXT_PASTE_CHAR_THRESHOLD = get_env_int("BUGPILOT_CLI_PASTE_CHAR_THRESHOLD", 1000)
_TEXT_PASTE_LINE_THRESHOLD = get_env_int("BUGPILOT_CLI_PASTE_LINE_THRESHOLD", 15)
