...
from bugpilot.tools.shell import Params, Shell
from bugpilot.tools.utils import DEFAULT_MAX_CHARS
...
async def test_timeout_parameter_validation_bounds(shell_tool: Shell):
    ...
    from bugpilot.tools.shell import MAX_BACKGROUND_TIMEOUT, MAX_FOREGROUND_TIMEOUT
...
def _capture_exec(monkeypatch: pytest.MonkeyPatch) -> list[str]:
    ...
    monkeypatch.setattr("bugpilot.tools.shell.kaos.exec", fake_exec)
    return captured
