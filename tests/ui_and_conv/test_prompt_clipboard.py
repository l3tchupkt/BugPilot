...
from bugpilot.ui.shell.prompt import PromptMode
from bugpilot.utils.clipboard import ClipboardResult
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from bugpilot.ui.shell.visualize import QuestionPromptDelegate, QuestionRequestPanel
    from bugpilot.wire.types import QuestionItem, QuestionRequest
