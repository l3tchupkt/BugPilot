...
from bugpilot.wire.types import ApprovalRequest, StatusUpdate, SteerInput, TextPart
...
_live_view_mod = importlib.import_module("bugpilot.ui.shell.visualize._live_view")
_interactive_mod = importlib.import_module("bugpilot.ui.shell.visualize._interactive")
...
def _make_two_question_request():
    ...
    from bugpilot.wire.types import QuestionItem, QuestionOption
    from bugpilot.wire.types import QuestionRequest as QR
...
def test_approval_feedback_cursor_markup_in_middle():
    ...
    from bugpilot.ui.shell.visualize._approval_panel import _render_feedback_with_cursor
