...
from bugpilot.ui.shell.visualize import _LiveView
...
def test_empty_think_then_real_think_no_artifact(monkeypatch):
    ...
    from bugpilot.ui.shell.console import console as shell_console
...
def test_step_retry_clears_partial_content_and_updates_live_status(monkeypatch):
    ...
    live_view_mod = importlib.import_module("bugpilot.ui.shell.visualize._live_view")
    view = _LiveView(StatusUpdate())
    printed = []
    monkeypatch.setattr(
