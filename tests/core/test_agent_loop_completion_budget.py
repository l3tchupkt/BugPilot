...
from bugpilot.soul.message import system
...
async def test_compaction_budget_reserves_next_main_request_overhead(
    ...
    monkeypatch.setattr(
        "bugpilot.soul.agent_loop.with_kimi_generation_overrides",
        fake_with_overrides,
    )
    monkeypatch.setattr("bugpilot.soul.agent_loop.wire_send", lambda _message: None)
