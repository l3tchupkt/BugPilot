"""Tests for bugpilot.session_fork module."""
...
from bugpilot.session_fork import (
    TurnInfo,
    _extract_user_text,
...
from bugpilot.wire.file import WireFileMetadata, WireMessageRecord  # noqa: I001
...
class TestForkSession:
    ...
    async def test_fork_sets_title(self, isolated_share_dir: Path, work_dir: KaosPath):
        from bugpilot.session import Session
        from bugpilot.session_state import load_session_state
