...
To enable chat providers other than BugPilot (e.g. Anthropic and Google Gemini), install the optional extra:
...
export BUGPILOT_API_KEY="your_bugpilot_api_key"

uv run python -m kosong bugpilot --with-bash
```
