...
- **路径**：`bugpilot.tools.ask_user:AskUserQuestion`
...
- **路径**：`bugpilot.tools.todo:SetTodoList`
...
- **路径**：`bugpilot.tools.file:ReadFile`
...
- **路径**：`bugpilot.tools.file:ReadMediaFile`
...
- **路径**：`bugpilot.tools.file:WriteFile`
...
- **路径**：`bugpilot.tools.file:StrReplaceFile`
...
- **路径**：`bugpilot.tools.web:FetchURL`
...
- **路径**：`bugpilot.tools.dmail:SendDMail`
...
- **路径**：`bugpilot.tools.plan.enter:EnterPlanMode`
...
- **路径**：`bugpilot.tools.plan:ExitPlanMode`
...
- **路径**：`bugpilot.tools.background:TaskList`
...
- **路径**：`bugpilot.tools.background:TaskOutput`
...
- **路径**：`bugpilot.tools.background:TaskStop`
