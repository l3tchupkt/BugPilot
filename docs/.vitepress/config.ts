...
export default withMermaid(defineConfig({
  base,
  title: 'BugPilot Docs',
  description: 'BugPilot Documentation',
  ...
  locales: {
    zh: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: '参考手册', link: '/zh/reference/bugpilot-command', activeMatch: '/zh/reference/' },
          ...
          '/zh/reference/': [
            {
              text: '参考手册',
              items: [
                { text: 'bugpilot 命令', link: '/zh/reference/bugpilot-command' },
                { text: 'bugpilot info 子命令', link: '/zh/reference/bugpilot-info' },
                { text: 'bugpilot acp 子命令', link: '/zh/reference/bugpilot-acp' },
                { text: 'bugpilot mcp 子命令', link: '/zh/reference/bugpilot-mcp' },
                { text: 'bugpilot term 子命令', link: '/zh/reference/bugpilot-term' },
                { text: 'bugpilot vis 子命令', link: '/zh/reference/bugpilot-vis' },
                { text: 'bugpilot web 子命令', link: '/zh/reference/bugpilot-web' },
    ...
    en: {
      ...
      link: '/en/',
      title: 'BugPilot Docs',
      description: 'BugPilot User Documentation',
      themeConfig: {
        nav: [
          ...
          { text: 'Reference', link: '/en/reference/bugpilot-command', activeMatch: '/en/reference/' },
          ...
          '/en/reference/': [
            {
              text: 'Reference',
              items: [
                { text: 'bugpilot Command', link: '/en/reference/bugpilot-command' },
                { text: 'bugpilot info Subcommand', link: '/en/reference/bugpilot-info' },
                { text: 'bugpilot acp Subcommand', link: '/en/reference/bugpilot-acp' },
                { text: 'bugpilot mcp Subcommand', link: '/en/reference/bugpilot-mcp' },
                { text: 'bugpilot term Subcommand', link: '/en/reference/bugpilot-term' },
                { text: 'bugpilot vis Subcommand', link: '/en/reference/bugpilot-vis' },
                { text: 'bugpilot web Subcommand', link: '/en/reference/bugpilot-web' },
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/l3tchupkt/bugpilot' },
    ],
  },
