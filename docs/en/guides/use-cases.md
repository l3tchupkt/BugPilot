...
BugPilot can help you complete various software development and general tasks. Here are some typical scenarios.

## Implementing new features

When you need to add new features to your project, simply describe your requirements in natural language. BugPilot will automatically read relevant code, understand the project structure, and then make modifications.

```
Add pagination to the user list page, showing 20 records per page
```

BugPilot typically works through a "Read → Edit → Verify" workflow:
...
If you're not satisfied with the changes, you can tell BugPilot to adjust:
...
Describe the problem you're encountering, and BugPilot will help you locate the cause and fix it:
...
You can also have BugPilot run commands to reproduce and verify the issue:
...
BugPilot can help you explore and understand unfamiliar codebases:
...
BugPilot can perform various repetitive small tasks:
...
Beyond code-related tasks, BugPilot can also handle some general scenarios.
